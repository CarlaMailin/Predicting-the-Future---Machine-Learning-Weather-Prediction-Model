...
## Aim
Building ML models to predict a forecast vector from different timeseries formats (single points, grids) and find out what is important for predicting precipitation.
...
## Outcome
[Project Presentation](PeterMailinVasileiosAikaterini_Predicting_the_past.pdf)

### Single Point Feature Importance
...
### Small grid cross-predicting seasons
...
### Small grid hindcasting with recent Years training
